...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list \
   CONFIG.CLKOUT1_JITTER {211.552} \
   CONFIG.CLKOUT1_PHASE_ERROR {239.466} \
  ...
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins clk_wiz_0/clk_out1] [get_bd_pins proc_sys_reset_0/slowest_sync_clk] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins v_axi4s_vid_out_0/aclk] [get_bd_pins v_tc_0/clk] [get_bd_pins v_tpg_0/ap_clk]
  ...
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins axi_interconnect_0/M00_ARESETN] [get_bd_pins axi_interconnect_0/S00_ARESETN] [get_bd_pins proc_sys_reset_0/peripheral_aresetn] [get_bd_pins v_axi4s_vid_out_0/aresetn] [get_bd_pins v_tc_0/resetn] [get_bd_pins v_tpg_0/ap_rst_n]
  ...
  connect_bd_net -net xlslice_0_Dout [get_bd_ports VGA_B] [get_bd_pins VGA_B/Dout]
  connect_bd_net -net xlslice_1_Dout [get_bd_ports VGA_G] [get_bd_pins VGA_G/Dout]
  connect_bd_net -net xlslice_2_Dout [get_bd_ports VGA_R] [get_bd_pins VGA_R/Dout]
