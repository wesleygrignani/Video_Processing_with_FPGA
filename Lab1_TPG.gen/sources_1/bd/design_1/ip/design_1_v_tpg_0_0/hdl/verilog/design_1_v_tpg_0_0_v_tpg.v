...
(* CORE_GENERATION_INFO="design_1_v_tpg_0_0_v_tpg,hls_ip_2020_2,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020-clg484-1,HLS_INPUT_CLOCK=6.734000,HLS_INPUT_ARCH=dataflow,HLS_SYN_CLOCK=6.648600,HLS_SYN_LAT=-1,HLS_SYN_TPT=-1,HLS_SYN_MEM=5,HLS_SYN_DSP=0,HLS_SYN_FF=6180,HLS_SYN_LUT=7076,HLS_VERSION=2020_2}" *)
